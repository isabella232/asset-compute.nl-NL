...
audience: end-user
user-guide-title: Servicegids voor bedrijfsmiddelen
...
breadcrumb-title: Servicegids voor bedrijfsmiddelen
...
+ [Ondersteunde bestandsindelingen](https://docs.adobe.com/content/help/en/experience-manager-cloud-service/assets/file-format-support.html)
...
+ De service Asset Compute uitbreiden {#extend}
   ...
   + [Integreer en gebruik in Experience Manager als Cloud Service](https://docs.adobe.com/content/help/en/experience-manager-cloud-service/assets/asset-microservices-overview.html)
